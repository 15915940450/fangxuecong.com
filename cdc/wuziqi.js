...
class FxcGomoku{
  constructor(){
    ...
    this.numPaddingLeft=40;  //左边距
    this.numPaddingTop=40; //上边距
    ...
    this.eleGameOver=document.querySelector('.gomoku h2');
    this.bIsOver=false;
    this.arrWins=[];
    this.numAllWins=0;
    this.arrHumanWin=[];
  ...
  drawPiece(strPiece,ia,j15,numStep){
    ...
    var arrPositionIaJ15=[this.numCeilWidth*ia+this.numPaddingLeft,this.numCeilWidth*j15+this.numPaddingTop];
  ...
  dealClick(pieceColor,numOffsetX,numOffsetY){
    ...
    var floatX=(numOffsetX-this.numPaddingLeft)/this.numCeilWidth;
    var floatY=(numOffsetY-this.numPaddingTop)/this.numCeilWidth;
